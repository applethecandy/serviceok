...
<body>
    ...
    <div class="modal">
        <div class="modal__content">
            <h2 class="h2">Ваш заказ создан</h2>
            <p class="h4">Наши специалисты найдут вам подходящего исполнителя и свяжутся с вами в течении 15 минут
                в рабочее время</p>
            <button class="button-main" id="modal-close">Готово</button>
        </div>
    </div>
</body>
