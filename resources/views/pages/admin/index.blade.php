        ...
        <tbody>
            @foreach ($clients as $client)
                <tr>
                    ...
                    <td data-title="Phone">{{ $client->work->service->title }}</td>
                    <td data-title="Phone">{{ $client->work->date }}</td>
                    <td data-title="Phone">{{ $client->work->time }}</td>
                    <td data-title="Phone">{{ $client->work->address }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
